...
from constants import SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_FILL_COLOR, GAME_CAPTIONS
...
class Game:
    ...
    def show_game_score(self):
        game_score_text = self.game_font.render(f"You Score is:{self.game_score}", True, 'white')
